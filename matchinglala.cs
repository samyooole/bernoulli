...
public class MatchingEngine
{
    ...
    public void DynamicMarketMakerRebate(decimal constant, decimal gradient, decimal rebatePercentage, decimal settlementFeePercentage)
    {
        ...
        foreach (var hourGroup in _contractMap)
        {
            ...
            decimal totalAddedVolume = constant + gradient * (rebatePercentage * 100);
            ...
            foreach (var ask in asks)
            {
                ...
                decimal settled = Math.Min(totalAddedVolume * 170, ask.Quantity );
            ...
            foreach (var bid in bids)
            {
                ...
                decimal settled = Math.Min(totalAddedVolume * 170, bid.Quantity);
...
class Program
{
    static void Main(string[] args)
    {
        ...
        decimal settlementFeePercentage = 0.000001m; // 0.0001%
